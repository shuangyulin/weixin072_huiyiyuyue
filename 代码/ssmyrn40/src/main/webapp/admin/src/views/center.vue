<template>
  <div>
    ...
    >  
     <el-row>
      <el-col :span="12">
        <el-form-item   v-if="flag=='fabuzhe'"  label="账号" prop="zhanghao">
          <el-input v-model="ruleForm.zhanghao" readonly              placeholder="账号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='fabuzhe'"  label="姓名" prop="xingming">
          <el-input v-model="ruleForm.xingming"               placeholder="姓名" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='fabuzhe'"  label="年龄" prop="nianling">
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='fabuzhe'"  label="手机" prop="shouji">
          <el-input v-model="ruleForm.shouji"               placeholder="手机" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="24">  
        <el-form-item v-if="flag=='fabuzhe'" label="照片" prop="zhaopian">
          <file-upload
          tip="点击上传照片"
          action="file/upload"
          :limit="3"
          ...
          @change="fabuzhezhaopianUploadChange"
          ></file-upload>
        </el-form-item>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    fabuzhezhaopianUploadChange(fileUrls) {
    ...
    onUpdateHandler() {
      if((!this.ruleForm.zhanghao)&& 'fabuzhe'==this.flag){
      ...
      if((!this.ruleForm.xingming)&& 'fabuzhe'==this.flag){
        this.$message.error('姓名不能为空');
        return
      }
      if((!this.ruleForm.nianling)&& 'fabuzhe'==this.flag){
        this.$message.error('年龄不能为空');
        return
      }
      if( 'fabuzhe' ==this.flag && this.ruleForm.nianling&&(!isIntNumer(this.ruleForm.nianling))){
       this.$message.error(`年龄应输入整数`);
        return
      }
      if((!this.ruleForm.shouji)&& 'fabuzhe'==this.flag){
        this.$message.error('手机不能为空');
        return
      }
      if( 'fabuzhe' ==this.flag && this.ruleForm.shouji&&(!isMobile(this.ruleForm.shouji))){
