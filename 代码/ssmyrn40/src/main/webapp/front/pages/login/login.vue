<template>
	<view class="content">
		<view class="logo">
			<image :style='{"boxShadow":"0 0 16rpx #59f43e","borderColor":"#ccc","borderRadius":"40rpx","borderWidth":"2rpx","width":"160rpx","borderStyle":"solid","url":"http://codegen.caihongy.cn/20210505/19e7e20e261e486f8cf9fccfa861a819.jpg","isShow":true,"height":"160rpx"}' src='http://codegen.caihongy.cn/20210505/19e7e20e261e486f8cf9fccfa861a819.jpg' mode="aspectFill"></image>
		</view>
		...
		<view class="links">
            			            <view class="link-highlight" @tap="onRegisterTap('fabuzhe')" :style='{"color":"rgba(23, 152, 242, 1)","fontSize":"24rpx"}'>注册发布者</view>
            <view>|</view>
